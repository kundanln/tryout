...
export class InstallmentFallowUpButton implements ICellRendererAngularComp {
    ...
    public invokeParentMethod() {
      ...
      // console.log("ButtonCompo1 ",this.params.data.id);
    //    let regID=+this.params.data.registrationId;
    //    this._router.navigate(['/installmentDetails',regID]);
       this.params.context.componentParent.methodFromParent(`${this.params.data.id}`)
